...
% load list
list = importdata('dbs_FA_CB_subpart_mkD_data_a.xlsx');
...
model_mat=[1 0 0;
           ...
           0 1 1;
           1 1 1;];
[p,tbl,stats] = anovan(y,{g1,g2,g3},"Model",model_mat,"Varnames",["PrePost","side","part"]);
...
for part = 1:4
    % pre, side=1
    idx = (list.data(:,2) == 1 & list.data(:,3) == 1 & list.data(:,4) == part);
    ...
    % post, side=1
    idx = (list.data(:,2) == 2 & list.data(:,3) == 1 & list.data(:,4) == part);
    vals = list.data(idx,1);
...
for part = 1:4
    % pre, side=2
    idx = (list.data(:,2) == 1 & list.data(:,3) == 2 & list.data(:,4) == part);
    vals = list.data(idx,1);
    ...
    % post, side=2
    idx = (list.data(:,2) == 2 & list.data(:,3) == 2 & list.data(:,4) == part);
    vals = list.data(idx,1);
...
n_SCC_pre_sham = sum(list.data(:,4) == 1 & list.data(:,2) == 1 & list.data(:,3) == 1);
n_SCC_post_sham = sum(list.data(:,4) == 1 & list.data(:,2) == 2 & list.data(:,3) == 1);
n_SCC_pre_con = sum(list.data(:,4) == 1 & list.data(:,2) == 1 & list.data(:,3) == 2);
n_SCC_post_con = sum(list.data(:,4) == 1 & list.data(:,2) == 2 & list.data(:,3) == 2);

n_dACC_pre_sham = sum(list.data(:,4) == 2 & list.data(:,2) == 1 & list.data(:,3) == 1);
n_dACC_post_sham = sum(list.data(:,4) == 2 & list.data(:,2) == 2 & list.data(:,3) == 1);
n_dACC_pre_con = sum(list.data(:,4) == 2 & list.data(:,2) == 1 & list.data(:,3) == 2);
n_dACC_post_con = sum(list.data(:,4) == 2 & list.data(:,2) == 2 & list.data(:,3) == 2);

n_MCC_pre_sham = sum(list.data(:,4) == 3 & list.data(:,2) == 1 & list.data(:,3) == 1);
n_MCC_post_sham = sum(list.data(:,4) == 3 & list.data(:,2) == 2 & list.data(:,3) == 1);
n_MCC_pre_con = sum(list.data(:,4) == 3 & list.data(:,2) == 1 & list.data(:,3) == 2);
n_MCC_post_con = sum(list.data(:,4) == 3 & list.data(:,2) == 2 & list.data(:,3) == 2);

n_PCC_pre_sham = sum(list.data(:,4) == 4 & list.data(:,2) == 1 & list.data(:,3) == 1);
n_PCC_post_sham = sum(list.data(:,4) == 4 & list.data(:,2) == 2 & list.data(:,3) == 1);
n_PCC_pre_con = sum(list.data(:,4) == 4 & list.data(:,2) == 1 & list.data(:,3) == 2);
n_PCC_post_con = sum(list.data(:,4) == 4 & list.data(:,2) == 2 & list.data(:,3) == 2);

%% tbls to excel
writetable(tbl2, 'dbs_FA_CBpart_mkD_tbl2_results.xlsx');